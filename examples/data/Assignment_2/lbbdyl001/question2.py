...
if x=='yes':
    ...
    if y=='yes':
        ...
        if z=='yes':
            ...
            if a=='yes':print("Decision: Eat it.")
            else:print("Decision: Your call.")
        if z=='no':
            b=input("Is it chocolate? (yes/no)"'\n')
            if b=='yes':print("Decision: Eat it.")
...
if x=='no':
    ...
    if c=='no':
        ...
        if h=='yes':
            ...
            if i=='yes':print("Decision: Eat it.")
            else:print("Decision: Don't eat it.")
        if h=='no':
            f=input("Did the cat lick it? (yes/no)"'\n')
            if f=='yes':
