#Program that analyses student marks from a file and return list of students who should see an advisor
#Kimberley Naidoo
#13 May 2014
...
#calculation: sum of the square of the difference between each student's mark and the mean
for i in range(learners_num):
...
for i in range(learners_num):
    if (eval(lines[i][lines[i].find(",")+1:]) < average-standard_deviation):
        advisor = True #catagorize student who need to see a student advisor
