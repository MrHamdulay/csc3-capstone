...
def add_block (grid):
    """ this will add a random number to a random location on the grid"""
...
def play ():
    """this wll help generate grid and play game interactively"""
    # create grid
    grid = []
...
# this will help initialize the random number generator to a fixed sequence
random.seed (12)
# play the game
play ()
