...
def push_up(grid):
    ...
    for x in range(4):
        ...
        for y in range(4):
            col.append(grid[y][x])
        #Remove the zeroes that appear before certain numbers
        ...
        for num in range(3):
            if col[num-dn] == 0:
                ...
                dn += 1
        #Going from top to bottom in the original grid, add similar adjacent numbers and store the sum in the upper of the two blocks.
