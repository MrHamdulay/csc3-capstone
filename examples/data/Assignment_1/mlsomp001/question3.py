...
money30=((money*30/100)*USD)

print("Dearest",firstname,)
print("It is with a heavy heart that I inform you of the death of my father,")
print("General Fayk,",firstname,",your long lost relative from Mapsfostol.")
print("My father left the sum of",money,"for us, your distant cousins.")
