# program to send personalised spam to a user given their name, country of residence, and state of their bank account
# by: Tom New

# defines the function to send spam to the user
def spam(first_name, last_name, money, country):
    print("\nDearest", first_name)
...
spam(first_name, last_name, money, country)