...
def get_change(final_amount,cost):
	
	'''Function that gets the change in $1,25c,10c,5c,1c'''
	
	change_in_cents = final_amount - cost
...
def main():
	''' main function getting the amounts, getting more input until cost is exceeded by money
	and then calls on the get_change function to find the change'''
