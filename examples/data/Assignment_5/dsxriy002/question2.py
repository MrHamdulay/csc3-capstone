...
#Ask user for the cost of the product
...
#Check to see if change is greater than $1
...
#Check to see if change is greater than 25c
...
#Check to see if change is greater than 10c   
...
#Check to see if change is greater than 5c   
...
#Check to see if change is greater than 1c   
