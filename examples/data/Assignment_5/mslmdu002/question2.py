"""A vending machine simulation program and it should calculate change based on the amount paid.
Mduduzi Masilela
17 April 2014"""

def vendor():
    '''Vending Machine cost and change'''
    cost=eval(input('Enter the cost (in cents):\n'))
    
    deposit=0
    while deposit<cost: #When the money deposited is not enough ,ask for more
